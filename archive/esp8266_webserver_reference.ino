...

{
      ...
      //Sends AT command with time (For setting mode of Wifi)
...

      {
        ...
        connect_wifi("AT+CWJAP=\"YOUR_WIFI_SSID\",\"YOUR_WIFI_PASSWORD\"",7000);         //provide your WiFi username and password here
